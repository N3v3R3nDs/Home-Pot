...
const en = {
  ...
  enable: 'Enable',
  spectatorLinkCopied: 'Spectator link copied 📋',
  tableMonitor: 'Table monitor',
  cashedOutShort: 'cashed out',
  seated: 'seated',
  joinLabel: 'Join',
  noOneSeated: 'No one seated yet.',
  toppedUp: '{name} topped up {amount}',
  boughtIn: '{name} bought in {amount}',
  joinedTable: '{name} joined',
  codeNotFound: 'No game with code "{code}"',
  notFound: 'Not found',
  latestAction: 'Latest',
  agoSuffix: 'ago',
  spectator: 'spectator',
  showQr: 'Show QR',
  hideQr: 'Hide QR',
  fullscreen: 'Fullscreen (Esc to exit)',
  exitFullscreen: 'Exit fullscreen (Esc)',
  exit: 'exit',
  inLabel: 'in',
  sessionRunning: 'Session running',
  perHour: '/hr',
  topUpChampion: 'Top-up champion',
  nTopUps: '{n} top-ups',
...
const no: typeof en = {
  ...
  enable: 'Aktivér',
  spectatorLinkCopied: 'Tilskuer-lenke kopiert 📋',
  tableMonitor: 'Bordmonitor',
  cashedOutShort: 'kjøpt ut',
  seated: 'sitter',
  joinLabel: 'Bli med',
  noOneSeated: 'Ingen sitter ved bordet ennå.',
  toppedUp: '{name} fylte på {amount}',
  boughtIn: '{name} kjøpte seg inn {amount}',
  joinedTable: '{name} satte seg',
  codeNotFound: 'Ingen kamp med kode «{code}»',
  ...
  showQr: 'Vis QR',
  hideQr: 'Skjul QR',
  fullscreen: 'Fullskjerm (Esc for å lukke)',
  exitFullscreen: 'Lukk fullskjerm (Esc)',
  exit: 'lukk',
  inLabel: 'inn',
  sessionRunning: 'Pågående økt',
  perHour: '/t',
  topUpChampion: 'Påfyll-mester',
  nTopUps: '{n} påfyll',
  biggestStake: 'Største stack',
  hotSeat: 'Het sete',
